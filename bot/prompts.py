...
0. Оценить, насколько ответ пользователя соответсвует вопросу. Если ответ пользователя не имеет смысла в контексте вопроса, пропустить дальнейшие шаги и сказать, что от собеседнкиа ждут серьезности.
